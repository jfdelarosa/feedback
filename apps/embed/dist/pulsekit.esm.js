...
const cf = {
  ...
  key: 2,
  class: "text-center py-8 text-primary-content/50"
}, uf = {
  key: 3,
  class: "text-center py-8 text-primary-content/50"
}, ff = { key: 0 }, hf = {
  ...
  setup(e) {
    ...
    return bs(
      async () => {
        o(t.projectId), t.user && (r(t.user), i(t.user)), pn(() => {
          h();
        });
      }
    ), (u, m) => (X(), Q("div", cf, [
